...
internal typealias RemoteHostResolver = (String) -> List<InetAddress>

internal fun String.ensurePublicHttpsUrl(
...
internal fun String.ensurePublicUrl(
    allowHttp: Boolean,
    resolveHost: Boolean = false,
    resolver: RemoteHostResolver? = null,
): HttpUrl {
...
internal fun String.requirePublicRemoteHost(
    resolveHost: Boolean = false,
    resolver: RemoteHostResolver? = null,
): String {
