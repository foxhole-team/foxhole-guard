...
internal fun HomeUiState.toHomeRouteUiState(
    ...
    protocolTunnelPingsByOptionId: Map<String, Long> = emptyMap(),
    protocolTunnelPingUnavailableOptionIds: Set<String> = emptySet(),
    ...
    HomeRouteUiState(
        ...
        protocolTunnelPingsByOptionId = protocolTunnelPingsByOptionId,
        protocolTunnelPingUnavailableOptionIds = protocolTunnelPingUnavailableOptionIds,
