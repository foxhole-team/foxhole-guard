...
private fun ConnectionSnapshot.isSameIdentityRefreshRuntime(other: ConnectionSnapshot): Boolean =
    profileId == other.profileId &&
        protocolOptionId == other.protocolOptionId &&
        trafficMode == other.trafficMode &&
        state == other.state &&
        lastChangeAt == other.lastChangeAt
