...
internal suspend fun FoxholeVpnService.runTunnelConnectivityProbe(
    ...
    TunnelConnectivityProbe.run(
        ...
        runTunnelValidationAttempt(validationRun, expectedFreshVpnNetworkHandle)
    }
...
private suspend fun FoxholeVpnService.runTunnelValidationAttempt(
    ...
    val networkContext = awaitRuntimeValidationNetworkContext(validationRun, expectedFreshVpnNetworkHandle)
