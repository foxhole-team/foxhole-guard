...
class RoutingRepository(
    ...
    suspend fun upsertRule(
        ...
        require(
            matchDomains.isNotEmpty() || matchIpCidrs.isNotEmpty() || matchPorts.isNotEmpty() || matchProtocols.isNotEmpty() || matchNetworks.isNotEmpty()
        ) {
    ...
    suspend fun addCatalog(
        ...
        return catalogDao.insert(
            RoutingCatalogEntity(
                name = name.ifBlank { normalizedUrl.host },
