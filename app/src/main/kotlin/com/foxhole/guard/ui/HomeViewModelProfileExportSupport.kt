...
import com.foxhole.core.profile.PreparedProfileExport
import com.foxhole.core.profile.ProfileExportPayload
import com.foxhole.core.profile.ProfileExportRequest
import com.foxhole.core.profile.createProfileExportArtifact
import com.foxhole.core.profile.exportableProfileChoices
import java.io.File

internal suspend fun HomeViewModel.createProfileExport(
    profileId: Long,
    selectionKeys: Set<String>,
): PreparedProfileExport = createProfileExport(listOf(ProfileExportRequest(profileId, selectionKeys)))
...
internal fun HomeViewModel.exportProfileShareIntent(document: PreparedProfileExport): Intent {
    val uri =
    ...
    return Intent(Intent.ACTION_SEND).apply {
        ...
        putExtra(
            ...
            getApplication<Application>().getString(com.foxhole.guard.R.string.profile_export_share_subject)
        )
        putExtra(
            Intent.EXTRA_TEXT,
            getApplication<Application>().getString(com.foxhole.guard.R.string.profile_export_share_text)
        )
