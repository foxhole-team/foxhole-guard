...
/** Historical brand neon shared by Guard, neutral map chrome and informational terminal rows. */
internal val CliNeonBlue = Color(0xFF2FD9F2)

/** Quiet informational blue for footnotes; deliberately distinct from the brand neon. */
internal val CliNoteBlue = Color(0xFF58A6FF)

/**
 * The single palette never changes with panel appearance. The network lanes own one colour each:
 * VPN is green, TOR is orange, I2P pink, and firewall traffic is blue. DNS filtering keeps violet
 * as a separate non-route lane.
 *
...
data class CliColors(
    ...
    val dnsFilter: Color = Color(0xFFB07CFF),
...
/** Default panels are either canon-filled or transparent; palette and explicit fills stay fixed. */
...
fun CliTheme(
    ...
    CompositionLocalProvider(
        ...
        LocalCliPanelAppearance provides panelAppearance,
