...
// quick-access pill) in place. Full disable stays a settings-screen action (onI2pEnabledChanged).
internal fun HomeViewModel.onI2pEngagedChanged(value: Boolean) {
    updateRuntimeSettingAndMaybeReload {
