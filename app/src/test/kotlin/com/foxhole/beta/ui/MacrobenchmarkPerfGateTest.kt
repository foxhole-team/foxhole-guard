...
class MacrobenchmarkPerfGateTest {
    ...
    fun `ci macrobenchmark script generates baseline profile during full suite`() {
        ...
        assertTrue(beforeAfterScript.contains("verify_target_apk_has_packaged_baseline_profile"))
        assertTrue(beforeAfterScript.contains("assets/dexopt/baseline.prof"))
        assertTrue(beforeAfterScript.contains("assets/dexopt/baseline.profm"))
        assertTrue(beforeAfterScript.contains("Target package does not include bundled baseline profile assets"))
        assertTrue(beforeAfterScript.contains("debug target usually does not package release baseline profiles"))
