...
class TrafficMapStylingTest {
    ...
    fun `traffic map route lines use readable stroke constants and semantic tokens`() {
        ...
        assertTrue(source.contains(".clickable { onMarkerSelected(target) }"))
        ...
        assertTrue(source.contains("TrafficMapDetailRange.TOP_10"))
        assertTrue(source.contains("TrafficMapDetailFilter.HEAVY"))
    ...
    fun `traffic map dashboard opens full detail route with country totals table`() {
        ...
        assertTrue(mapSource.contains("TrafficMapDetailRange.TOP_30"))
