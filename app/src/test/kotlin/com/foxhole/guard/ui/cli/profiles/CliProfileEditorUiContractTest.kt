...
class CliProfileEditorUiContractTest {
    ...
    fun `manual editor is full height and saves any supported config text`() {
        ...
        assertTrue(footer.indexOf("cli_common_close_action") < footer.indexOf("cli_prof_edit_raw"))
        assertTrue(footer.contains("color = colors.accent"))
        ...
        assertTrue(manual.indexOf("cli_common_close_action") < manual.indexOf("cli_prof_config_save_action"))
