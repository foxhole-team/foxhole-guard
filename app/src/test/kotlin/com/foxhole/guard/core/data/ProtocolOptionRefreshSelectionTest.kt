...
class ProtocolOptionRefreshSelectionTest {
    ...
    @Test
    fun `subscription refresh replaces stale selected id with a connectable imported option`() {
        val imported =
            profile(
                selectedProtocolOptionId = "hysteria2",
        ...
        assertEquals("hysteria2", imported.resolveRefreshSelectedProtocolOptionId(previous))
    }
