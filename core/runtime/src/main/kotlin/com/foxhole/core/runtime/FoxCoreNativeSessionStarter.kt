    ...
    private fun startHandle(
        ...
        val handle =
            runCatching {
                ...
                diagnosticsLogger.record("foxcore", "native start rejected")
            }.getOrNull()
        ...
        bootstrap
            ...
            ?.let { update ->
                runCatching {
                    ...
                    // The trusted APK artifact remains active. A stale, corrupt or rolled-back
                    // network update must neither fail open nor tear down a healthy tunnel.
