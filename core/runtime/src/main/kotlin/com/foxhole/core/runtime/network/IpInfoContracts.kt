...
// The Tor Project's own exit check. Strict Tor acceptance uses only this endpoint and requires an
// explicit `IsTor: true`; ordinary Tor-route display refreshes may still enrich its result later.
