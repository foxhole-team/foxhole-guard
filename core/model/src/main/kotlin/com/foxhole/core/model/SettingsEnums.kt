...
// The statistics screen's day/week dropdown. The choice is remembered forever, so it lives in the
// settings store and must be @Serializable — the app-module StatisticsDisplayRange is not.
