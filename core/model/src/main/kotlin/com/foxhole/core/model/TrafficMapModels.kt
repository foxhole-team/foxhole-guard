...
enum class TrafficMapI2pCarrier {
    /** Standalone transparent local-guard TUN owned by the device-side runtime. */
    DEVICE,

    /** Active positive-id VPN profile is the last applied privacy route carrying I2P. */
    VPN,
...
data class TrafficMapUiState(
    ...
    // Runtime ownership of that live carrier. Null means the map cannot honestly place an I2P
    // lane; settings never populate this field.
