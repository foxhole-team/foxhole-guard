...
readonly DEFAULT_CONNECTED_SPECS="com.foxhole.guard.ui.cli.home.CliHomeRuntimeBehaviorTest,com.foxhole.core.runtime.DnsFilterAssetInstallerDeviceTest,com.foxhole.core.runtime.TorRuntimeInstallerDeviceTest,com.foxhole.core.runtime.BootReceiverRestoreAndroidTest"

usage() {
  cat <<'EOF'
Usage:
  ANDROID_SERIAL=PIXELDEVICE0001 FOXHOLE_DEVICE_PROOF_LABEL=pixel-debug \
...
run_local_firewall_stress() {
  "$GRADLEW" --no-daemon --console=plain --stacktrace :app:connectedDebugAndroidTest \
    -Pandroid.testInstrumentationRunnerArguments.class=com.foxhole.core.runtime.LiveLocalFirewallGuardRuntimeTest \
