...
readonly APP_PACKAGE="${FOXHOLE_SOAK_APP_PACKAGE:-com.foxhole.guard.debug}"
readonly TEST_PACKAGE="${FOXHOLE_SOAK_TEST_PACKAGE:-com.foxhole.guard.debug.test}"
readonly RUNNER="${FOXHOLE_SOAK_RUNNER:-androidx.test.runner.AndroidJUnitRunner}"
readonly TEST_CLASS="${FOXHOLE_SOAK_TEST_CLASS:-com.foxhole.guard.ProfileRuntimeGuardSessionAndroidTest}"
