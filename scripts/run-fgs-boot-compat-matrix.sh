...
readonly DEFAULT_REQUIRED_SPECS="com.foxhole.beta.vpn.BootReceiverRestoreAndroidTest,com.foxhole.beta.vpn.ProxyRuntimeSmokeTest"
...
Optional environment:
  FOXHOLE_ANDROID_TEST_TARGET_PACKAGE=com.foxhole.beta.debug
  ...
  FOXHOLE_REQUIRED_CONNECTED_TEST_SPECS=com.foxhole.beta.vpn.BootReceiverRestoreAndroidTest,com.foxhole.beta.vpn.ProxyRuntimeSmokeTest
EOF
}
