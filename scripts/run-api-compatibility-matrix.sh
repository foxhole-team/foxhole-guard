...
readonly DEFAULT_MATRIX_SPECS="com.foxhole.beta.vpn.BootReceiverRestoreAndroidTest,com.foxhole.beta.vpn.ProxyRuntimeSmokeTest,com.foxhole.beta.ui.HomeRuntimeBehaviorTest"
