...
Effective draft date (draft): 2026-07-11

App: FoxHole (`com.foxhole.guard`)

Developer/store listing entity: FoxHole

> **Required before publication (blocks Play Data safety):** this policy must be
> hosted at a stable public HTTPS URL and the two fields below filled in. Google
> Play and F-Droid both require a reachable policy URL and a working contact.
>
> - **Privacy contact:** `«FILL: public developer privacy contact email»`
> - **Policy public URL:** `«FILL: https URL where this document is hosted»`
...
FoxHole is free software licensed under the GNU General Public License v3.0 or
later. In accordance with GPL §6, the complete corresponding source code is
available at `«FILL: public source repository URL»`. This satisfies the
store-distribution written offer; the same URL should appear in the in-app
**About → Licenses** screen and in the store listing.
...
lists, local risk signals, traffic statistics, diagnostics, auto-connect history,
