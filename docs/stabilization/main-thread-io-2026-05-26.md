...
- `./gradlew --no-daemon --console=plain --stacktrace :app:testDebugUnitTest --tests com.foxhole.core.runtime.RuntimeHealthMetricsTest --tests com.foxhole.guard.BuildConfigDiagnosticsTest`
